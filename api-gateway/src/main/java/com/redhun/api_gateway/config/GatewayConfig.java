...
public class GatewayConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("question-service", r -> r.path("/api/admin/questions/**")
              ...
              .route("auth-service", r -> r.path("/api/admin/user/**").filters(f -> f.filter(authFilter.apply(new AuthenticationFilter.Config()))).uri("lb://auth-service"))
