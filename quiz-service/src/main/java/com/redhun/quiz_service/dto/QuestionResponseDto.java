...
import com.redhun.quiz_service.dto.OptionResponseDto;
...
public class QuestionResponseDto {
    ...
    public QuestionResponseDto(Long id, String question, Long difficultyId, List<OptionResponseDto> options, Long categoryId, Long correctAnswerId, String createdBy, LocalDateTime createdTime, String categoryName, String dificaltyName, Long questionTypeId, String questionTypeName) {
        this.id = id;
